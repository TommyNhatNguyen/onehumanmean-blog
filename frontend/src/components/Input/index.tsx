    ...
    <div className="flex w-full flex-col">
      ...
      >
        {inputType === "password" ? (
          <>
            <input
              className="h-full w-full border-none bg-[transparent] font-regular text-black-100 outline-none placeholder:font-regular placeholder:capitalize placeholder:text-gray-100 dark:text-white dark:placeholder:text-white"
